    ...
    void cambiosPropietario(ePropietario propietario[],int id) {
        ...
        do{
            ...
            printf("\n\n\t\t1- Nro Tarjeta       : %s",auxPropietario.nroTarjeta);
            ...
            switch(opcion){
                case 0:
                 ...
                 case 1:
                    ...
                    break;
 /*               case 2:
                    printf("\t\tIngresar nuevo domicilio     : ");
                    fflush(stdin);
  ...
  //                  strcpy(propietario[idPropietario].domicilio, auxPropietario.domicilio);
  //                  propietario[idPropietario].domicilio= auxPropietario.domicilio;
